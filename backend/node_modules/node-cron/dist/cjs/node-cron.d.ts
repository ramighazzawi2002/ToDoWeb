import { ScheduledTask, TaskFn, TaskOptions } from "node-cron/dist/cjs/tasks/scheduled-task";
...
export { ScheduledTask } from 'node-cron/dist/cjs/tasks/scheduled-task';
export type { TaskFn, TaskContext, TaskOptions } from 'node-cron/dist/cjs/tasks/scheduled-task';
