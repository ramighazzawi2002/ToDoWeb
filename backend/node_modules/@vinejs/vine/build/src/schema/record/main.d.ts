...
import { BaseType } from '@vinejs/vine/build/src/schema/base/main.js';
import { ITYPE, OTYPE, COTYPE, PARSE, UNIQUE_NAME, IS_OF_TYPE } from '@vinejs/vine/build/src/symbols.js';
import type { FieldOptions, ParserOptions, SchemaTypes, Validation } from '@vinejs/vine/build/src/types.js';
import { validateKeysRule } from '@vinejs/vine/build/src/schema/record/rules.js';
/**
