...
import { UnionConditional } from '@vinejs/vine/build/src/schema/union/conditional.js';
import { ITYPE, OTYPE, COTYPE, PARSE } from '@vinejs/vine/build/src/symbols.js';
import type { SchemaTypes, ParserOptions, ConstructableSchema, UnionNoMatchCallback } from '@vinejs/vine/build/src/types.js';
/**
