import { BaseLiteralType } from '@vinejs/vine/build/src/schema/base/literal.js';
import { IS_OF_TYPE, SUBTYPE, UNIQUE_NAME } from '@vinejs/vine/build/src/symbols.js';
import type { Validation, AlphaOptions, FieldContext, FieldOptions, AlphaNumericOptions, NormalizeEmailOptions } from '@vinejs/vine/build/src/types.js';
import { urlRule, uuidRule, emailRule, mobileRule, passportRule, creditCardRule, postalCodeRule, normalizeUrlRule } from '@vinejs/vine/build/src/schema/string/rules.js';
/**
...
export declare class VineString extends BaseLiteralType<string, string, string> {
    static rules: {
        ...
        mobile: (options?: import("@vinejs/vine/build/src/types.js").MobileOptions | ((field: FieldContext) => import("@vinejs/vine/build/src/types.js").MobileOptions | undefined) | undefined) => Validation<import("@vinejs/vine/build/src/types.js").MobileOptions | ((field: FieldContext) => import("@vinejs/vine/build/src/types.js").MobileOptions | undefined) | undefined>;
        string: (options?: undefined) => Validation<undefined>;
        hexCode: (options?: undefined) => Validation<undefined>;
        passport: (options: import("@vinejs/vine/build/src/types.js").PassportOptions | ((field: FieldContext) => import("@vinejs/vine/build/src/types.js").PassportOptions)) => Validation<import("@vinejs/vine/build/src/types.js").PassportOptions | ((field: FieldContext) => import("@vinejs/vine/build/src/types.js").PassportOptions)>;
        endsWith: (options: {
            substring: string;
        }) => Validation<{
            substring: string;
        ...
        creditCard: (options?: import("@vinejs/vine/build/src/types.js").CreditCardOptions | ((field: FieldContext) => import("@vinejs/vine/build/src/types.js").CreditCardOptions | void | undefined) | undefined) => Validation<import("@vinejs/vine/build/src/types.js").CreditCardOptions | ((field: FieldContext) => import("@vinejs/vine/build/src/types.js").CreditCardOptions | void | undefined) | undefined>;
        postalCode: (options?: import("@vinejs/vine/build/src/types.js").PostalCodeOptions | ((field: FieldContext) => import("@vinejs/vine/build/src/types.js").PostalCodeOptions | void | undefined) | undefined) => Validation<import("@vinejs/vine/build/src/types.js").PostalCodeOptions | ((field: FieldContext) => import("@vinejs/vine/build/src/types.js").PostalCodeOptions | void | undefined) | undefined>;
        startsWith: (options: {
            substring: string;
        }) => Validation<{
            substring: string;
